      ...
      <div className="mx-auto max-w-6xl px-6">
        <AnimatedSection className="mx-auto max-w-3xl text-center mb-14">
          <div className="inline-flex items-center gap-2 bg-rose-50 border border-rose-200 rounded-full px-4 py-2 mb-6">
            ...
            <span className="text-sm font-medium text-rose-700">Voce se identifica?</span>
          </div>
          
          <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold tracking-tight text-foreground text-balance">
            Planejar um evento nao deveria ser 
            <span className="text-rose-500"> tao dificil</span>
          </h2>
          
          <p className="mt-5 text-lg text-muted-foreground">
            Sabemos como e. Voce quer viver um momento especial, mas acaba perdido em meio a tantos detalhes.
          </p>
        </AnimatedSection>
